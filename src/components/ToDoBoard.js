...
class ToDoBoard extends Component {
    ...
    updateDateOfEntry = (id, field) => {
      this.setState({
        journal: this.state.journal.update(id, (n) => {
    ...
    render() {
      ...
      return (
        <div>
          ...
          <p>Enter Title:</p>
          <input type="text" value={this.state.newDateOfEntry} onChange={this.newTitleFunction} />
  
          <p>Enter Task:</p>
          <input type="text" value={this.state.newJournalEntry} onChange={this.newTaskFunction} />
